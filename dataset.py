...
if __name__ == "__main__":
    ...
    train_data = VideoDataset(dataset_path='mydata', images_path='train', clip_len=16)
    train_loader = DataLoader(train_data, batch_size=8, shuffle=True, num_workers=0)

    val_data = VideoDataset(dataset_path='mydata', images_path='val', clip_len=16)
    val_ader = DataLoader(val_data, batch_size=8, shuffle=True, num_workers=0)

    test_data = VideoDataset(dataset_path='mydata', images_path='test', clip_len=16)
    test_ader = DataLoader(test_data, batch_size=8, shuffle=True, num_workers=0)
