...
if __name__ == "__main__":
    ...
    train_dataloader = DataLoader(VideoDataset(dataset_path='mydata', images_path='train', clip_len=16), batch_size=16, shuffle=True, num_workers=2)
    val_dataloader = DataLoader(VideoDataset(dataset_path='mydata', images_path='val', clip_len=16), batch_size=16, num_workers=2)
    test_dataloader = DataLoader(VideoDataset(dataset_path='mydata', images_path='test', clip_len=16), batch_size=16, num_workers=2)
