...
split = 1  # official train/test splits. valid numbers: 1, 2, 3
ann_file_train = f'data/mydataset/train.txt'
ann_file_val = f'data/mydataset/val.txt'
ann_file_test = f'data/mydataset/val.txt'
...
load_from = 'mymodel/ucf101-caffe.pth'
